...
function Portfolio() {
  return (
    <section className='flex justify-center py-5 bg-gray-100' id='portfolio'>
        <div className='lg:w-4/5 md:w-[96%] w-[90%] flex flex-col items-center gap-8'>
            <div className='flex flex-col gap-3 md:w-3/5 w-4/5'>
                ...
                <p className='text-center text-gray-400 text-sm'>Here are some of the projects I've had the privilege to work on, each reflecting my commitment to creating high-quality, stylish, and user-friendly web applications.</p>
            </div>
                   ...
                   <img className='w-full h-[200px] rounded-t-md shadow-t-lg' src={Portfolio1}/>
                    <div className='flex justify-center'>
                        <div className='w-5/6 flex flex-col'>
                            <h5 className='text-gray-400 text-sm uppercase'>Front-end developer</h5>
                            <h2 className='text-gray-600 font-semibold lg:text-xl'>Milkomi Consultancy</h2>
                            ...
                            <div className='flex justify-start mt-4'>
                                <a href='https://milkomiconsultancy.com/'  target="_blank"  className='py-1.5 px-3 bg-transparent text-cyan-500 hover:bg-cyan-500 hover:text-white border-cyan-500 border rounded-md flex gap-2 font-semibold'>Case Study<FontAwesomeIcon icon={faArrowRight} className='pt-1.5'/></a>
                            </div>
                        </div>   
                    </div>                
                </div>
